...
class ColorsViewController: UIViewController {
    ...
    */
    ...
    private func initCollectionView() {
        ...
        let insetOffset = 24.0
        view.addSubview(colorCollection)
        NSLayoutConstraint.activate([
            colorCollection.leadingAnchor.constraint(equalTo: layoutMarginGuide.leadingAnchor, constant: insetOffset),
            colorCollection.trailingAnchor.constraint(equalTo: layoutMarginGuide.trailingAnchor, constant: -insetOffset),
            colorCollection.topAnchor.constraint(equalTo: layoutMarginGuide.topAnchor, constant: insetOffset),
            colorCollection.bottomAnchor.constraint(equalTo: layoutMarginGuide.bottomAnchor, constant: -insetOffset)
        ])
    }
}
...
class ColorCollectionViewDelegate: NSObject, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        let totalSpacing = collectionViewFlowLayout.sectionInset.left + collectionViewFlowLayout.sectionInset.right + (numberOfItemsPerRow - 1) * collectionViewFlowLayout.minimumInteritemSpacing
